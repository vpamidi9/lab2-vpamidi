...
set_input_delay -max 0.1 -clock rclk {rinc}
set_input_delay -max 0.1 -clock wclk {winc}
set_input_delay -min 0.1 -clock wclk2x {wdata_in[*]}
set_input_delay -min 0.1 -clock rclk {rinc}
set_input_delay -min 0.1 -clock wclk {winc}
